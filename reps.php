	        		...
	        		<?php
				        if(isset($_SESSION['error'])){
				        	...
				        	<div class="alert alert-danger alert-dismissible">
					        	...
					        	<ul>
					        		<?php
					        			foreach($_SESSION['test'] as $error){
					        				echo "
					        					<li>".$error."</li>
					        				";
					        			}
			        	...
			        	<span class="message"></span>
						    ...
						    <form method="POST" id="ballotForm" action="submit_ballot.php">
				        		<?php
									...
									if ($roww = mysqli_num_rows($query) == 1) {
														...
														<div class="box-body">
															<p>'.$instruct.'
																<span class="pull-right">
																	<button type="button" class="btn btn-success btn-sm btn-flat reset" data-desc="'.slugify($row['description']).'">
					        		...
					        		<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
						        	<ul>
												<li>No candidate for this category</li>
						        	</ul>
						        </div>';
									}
