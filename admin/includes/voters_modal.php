                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <select class="form-control" name="dept" required>
                        ...
                        while($dept_row = $dept_query->fetch_assoc()){?>
																<option value="<?php echo htmlentities($dept_row['id']);?>">
																	<?php echo htmlentities($dept_row['name']);?>
																</option>
																<?php } ?>
                      </select>
                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="voters_edit.php">
                ...
                <div class="form-group">
                    <label for="edit_dept" class="col-sm-3 control-label">Dept</label>

                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="edit_dept" name="dept" required>
                    </div>
                </div>
                <div class="form-group">
