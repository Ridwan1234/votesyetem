	  ...
	  <div class="content-wrapper">
	    <div class="container">
	      ...
	      <section class="content">
	      	...
	      	?>
	      	<h1 class="page-header text-center title text-primary"><b><?php echo strtoupper($title); ?></b></h1>
	        <div class="row">
	        	<div class="col-sm-10 col-sm-offset-1">
				    ...
				    <?php
						if(isset($_SESSION['elapse'])){
								echo "
									<div class='alert alert-success alert-dismissible'>
									<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
											<h4><i class='icon fa fa-times'></i> Elapse!</h4>
										".$_SESSION['elapse']."
									</div>
								";
					    	...
					    	if($vquery->num_rows > 0){
								...
								<button type="button" class="btn btn-primary btn-flat btn-lg">
									<i class="fa fa-check-square-o"></i> View Results</button></a>
								</center>
									<?php
						}else {
				    	$sql = "SELECT * FROM votes WHERE voters_id = '".$voter['id']."'";
						    ...
						    <form method="POST" id="ballotForm" action="submit_ballot.php">
										...
										while($crow = $cquery->fetch_assoc()){
											...
											$candidate .= '
												<li>
													...
													<i class="fa fa-search"></i> Manifesto
													</button>
													<img src="'.$image.'" height="200px" width="200px" class="clist">
														...
														<div class="box-body">
															<p>'.$instruct.'
																<span class="pull-right">
																	<button type="button" class="btn btn-danger btn-sm btn-flat reset" data-desc="'.slugify($row['description']).'">
				        		...
				        		<div class="text-center">
					        		<button type="button" class="btn btn-success btn-flat" id="preview">
												...
												<button type="submit" class="btn btn-primary btn-flat" name="next" id="">
													<i class="fa fa-check-square-o"></i> Next</button>
